 ...
 */
class FragmentControl(framLayoutId: Int, activity: AppCompatActivity) {

    private val frameLayoutId = framLayoutId
    private val fragments: ArrayList<Fragment> by lazy { arrayListOf<Fragment>() } //初始化装载Fragment的集合
    private val fragmentManager: FragmentManager by lazy { activity.fragmentManager }
     ...
     * 显示fragment的开关
     */
    fun switchFragment(position: Int): FragmentControl {
     ...
     */
    fun findWithByTag(kill: Boolean=true,array:ArrayList<String>) {
